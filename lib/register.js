...
export async function registerApplication (app, applicationDescriptor) {
  ...
  debug('Registering remote app with uuid ' + applicationDescriptor.shortUuid + ' and key ' + key + ' in local app with uuid ' + app.shortUuid + ' and key ' + app.distributionKey)
  ...
  if (!isRegistered) publishServices(app)
